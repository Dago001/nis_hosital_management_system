    ...
    <script>
        ...
        function renderSidebar() {
            ...
            const menuItems = [
                ...
                { path: '/appointments', label: 'Appointments',     icon: 'calendar',          roles: ['super_admin', 'hospital_admin', 'chief_medical_officer', 'doctor', 'consultant', 'nurse', 'records_officer', 'receptionist', 'ward_manager', 'dental_officer', 'eye_clinic_officer'] },
                { path: '/queue',        label: 'Queue Management', icon: 'list-ordered',      roles: ['super_admin', 'hospital_admin', 'medical_director', 'chief_medical_officer', 'doctor', 'consultant', 'nurse', 'receptionist', 'ward_manager', 'theatre_manager', 'records_officer'] },
                ...
                { path: '/ipd',          label: 'IPD / Ward Beds',  icon: 'building-2',        roles: ['super_admin', 'hospital_admin', 'medical_director', 'chief_medical_officer', 'doctor', 'nurse', 'ward_manager', 'theatre_manager'] },
                { path: '/referrals',    label: 'Referrals',        icon: 'arrow-right-left',  roles: ['super_admin', 'hospital_admin', 'medical_director', 'chief_medical_officer', 'doctor', 'consultant', 'nurse'] },
                { path: '/laboratory',   label: 'Laboratory',       icon: 'test-tube',         roles: ['super_admin', 'medical_director', 'chief_medical_officer', 'lab_scientist', 'radiographer', 'doctor'] },
                ...
                { path: '/procurement',  label: 'Procurement',      icon: 'truck',             roles: ['super_admin', 'hospital_admin', 'ict_admin', 'procurement_officer', 'store_officer', 'inventory_officer', 'account_officer'] },
                ...
                { path: '/reports',      label: 'Analytics',        icon: 'bar-chart',         roles: ['super_admin', 'hospital_admin', 'medical_director', 'chief_medical_officer', 'health_info_officer', 'records_officer', 'account_officer'] },
